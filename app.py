...
def main_screen():
    ...
    #icon
    image_icon=PhotoImage(file="resources/key.png")
    ...
    Label(text="Enter text for encryption and decryption and decryption", fg="black", font=("calbri", 13)).place(x=10, y=10)
    text1=Text(font="Robote 20", bg="white", relief=GROOVE, wrap=WORD, bd=0)
    text1.place(x=10, y=50, width=355, height=100)

    Label(text="Enter secrete key for encryption", fg="black", font=("calbri", 13)).place(x=10, y=170)
